        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card" >
                <div id="Listados" class="card-header d-flex justify-content-between">
                    <h5><a class="text-dark2">Listado de Actores y Actrices</a></h5>
                    <a href="{{route('actors.aCreate')}}" class="btn btn-outline-secondary btn-sm text-white">+ Crear Actor/Actris
                </a>
                </div>
                        ...
                        <tbody>
                                ...
                                @foreach ($actors as $dato)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('actors.aShowOne',[$dato->idActor])}}" class="btn btn-danger"><i class="fa fa-eye">Ver</i></a>
                                            <a href="{{ route('actors.aShowForm',[$dato->idActor])}}" class="btn btn-danger"><i class="fa fa-edit">Editar</i></a>
                                            <form method="POST" action="{{route('actors.aDelete',$dato)}}" style="display: inline-block;">
                                                {{method_field('delete')}}
                                                {!! csrf_field() !!}
                                                <input type="hidden" name="idActor" id="idActor" value="{{$dato->idActor}}">
                            ...
                            @else
                                <td class="font-italic text-center" colspan="3">
                                    No existen actores ó actrices registrados
                                </td>
                            @endif
                        </tbody>
                    </table>
